 ...
 * إتمام الشراء (عناوين/دفع) يُبنى في اليوم 9 حسب الخطة.
 */
          ...
          <View style={styles.summary}>
            ...
            {checkoutNote ? (
              <View style={styles.note}>
                <Ionicons name="information-circle-outline" size={16} color={colors.accentForeground} />
                <AppText size={11.5} color={colors.accentForeground} style={{ flex: 1 }}>
                  إتمام الشراء (العناوين والدفع) ضمن مهام اليوم 9 من خطة السباق.
                </AppText>
              </View>
            ) : null}
            <Button
              title="إتمام الشراء"
              onPress={() => setCheckoutNote(true)}
